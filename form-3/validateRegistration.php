...
<html xmlns='http://www.w3.org/1999/xhtml' lang='en'>
  ...
  background-size: cover;
    ...
    <body>";
 		...
 		{
			echo "You have successfully registered. Thankyou.<br/><br />Your registration id : ".$regid."  (Please keep a note of it)<br /><br /><a href='/Movie-Recommendation-System/index.html'>Vist the website</a>";
		}	
