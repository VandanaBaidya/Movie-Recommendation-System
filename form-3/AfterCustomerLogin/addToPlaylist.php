...
<html xmlns='http://www.w3.org/1999/xhtml' lang='en'>
  ...
  background-size: cover;
    ...
    <body>";
 		...
 		$songid = validate_data( $_POST['movieIDtextbox'] );
 		$regid = validate_data( $_POST['movieregid'] );
 		$playlistid="P".$regid;
		...
		$query="SELECT title,genres FROM movies WHERE movieId = '".$movieId."'";
		if($result=mysqli_query($con,$query))
 		...
 		{
			echo "<strong>Added to favourites.<br /><br />You could go back and add other movies too to the favourites.</strong>";
		}	

		else
		{
			echo "<strong>You have already added this movie to the favourites.<br/>Go back and add some other movie.</strong>";
		}
		}
		}
		else
