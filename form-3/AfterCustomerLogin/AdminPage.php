		        ...
		        <div class="row">	        		
		            <div class="navbar-header">
		                ...
		                <a class="navbar-brand" href="index.html">
		                	...
		                	<h1 style="text-indent:95px; color:white; font-weight: bold;">Movie Planet</h1>
						...
						<div class="carousel-inner">
							<div class="item active">
								<div class="row">
									...
									<div>
										<a href='viewCustomerActivity.php' class="btn btn-primary">View customer activities<i class="fa fa-angle-right"></i></a>
									</div>
								</div>
							</div>					
						</div>
