		...
		if ($result=mysqli_query($con,$sql))
  		{
    		...
    		{
    			//echo "Enetered if";
    			header("Location: /Movie-Recommendation-System/form-3/AfterCustomerLogin/AdminPage.php?adminname=".urlencode($row[1])."& adminid=".urlencode($adminid));
    			//header ("Location : /Movie-Recommendation-System/form-3/AfterCustomerLogin/AdminPage.php?adminname=".urlencode($row[1])."& adminid=".urlencode($adminid));
    		}
    		else
    		{
    			echo "Invalid admind ID or password<br /><br />Please re-enter valid details";
    			header("Refresh:2; url=/Movie-Recommendation-System/form-3/adminlogin.html#",true,303);
    		}
  			// Free result set
